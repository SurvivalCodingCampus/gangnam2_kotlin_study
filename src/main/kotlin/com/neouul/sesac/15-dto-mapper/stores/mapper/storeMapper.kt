...
import com.neouul.sesac.`15-dto-mapper`.stores.core.slashFormatToLocalDateTimeOrNull
import com.neouul.sesac.`15-dto-mapper`.stores.core.slashFormatToLocalDateTimeOrNull
...
fun StoreDTO.toModel(): Store {
    return Store(
        ...
        createdAt = created_at?.slashFormatToLocalDateTimeOrNull() ?: EMPTY_LOCALDATETIME,
        latitude = lat ?: EMPTY_DOUBLE,
        longitude = lng ?: EMPTY_DOUBLE,
        name = name ?: EMPTY_STRING,
        remainStat = remain_stat ?: EMPTY_STRING,
        stockAt = stock_at?.slashFormatToLocalDateTimeOrNull() ?: EMPTY_LOCALDATETIME,
    )
}